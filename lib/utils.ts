...
// Function to format date and time in various formats
...
// Function to form a URL with query parameters
...
// Function to extract customer ID from URL
...
// Function to get transaction status based on the date
